...
- `.github/workflows/deploy-frontend-vercel.yml`: build y deploy del frontend a Vercel en `main`.
...
- `docs/ci-cd/vercel.md`: secrets de GitHub Actions para deploy del frontend en Vercel.
